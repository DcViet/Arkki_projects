  ...
  >
    <div className="flex flex-col gap-6">
      <Project
        ...
        description="Trong Scrat's Journey, bạn sẽ bước chân vào hành trình phiêu lưu cùng Scrat. Tại đây, bạn sẽ được giới thiệu vào một thế giới mã nguồn đơn giản và thú vị, giúp bạn tiếp cận các khái niệm lập trình một cách dễ dàng và tương tác qua các thuật toán."
